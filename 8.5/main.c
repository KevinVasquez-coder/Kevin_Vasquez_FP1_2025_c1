...
/* Observa que uno de los campos de la estructura alumno es una unión. */
 ...
 /* Para que puedas observar las diferentes formas en que los campos de las variables de tipo estructura alumnoreciben valores, ingresamos los valores de los campos de tres formas diferentes. Los campos de a1reciben valores directamente, los campos de a2se leen en el programa principal, y los campos de a3 reciben valores a través de una función. */
 printf("Alumno 2\n");
 ...
 /* Observa que en la variable a2de tipo estructura alumnoel segundo campo de la unión recibe un valor. */
 printf("Alumno 3\n");
