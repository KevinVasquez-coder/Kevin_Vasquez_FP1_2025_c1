...
/* Empresa textil.
El programa, al recibir como datos decisivos la categoria y antigüedad de un empleado, determina si el mismo reune las condiciones establecidas por la empresa para ocupar un nuevo cargo en una sucursal.
