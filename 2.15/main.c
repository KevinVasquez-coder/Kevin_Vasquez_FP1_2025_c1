...
/* Spa.
El programa, al recibir como datos el tipo de tratamiento, la edad y el numero de días de internacion de un cliente en un spa, calcula el costo total del tratamiento.
