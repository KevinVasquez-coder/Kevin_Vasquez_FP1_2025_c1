...
/* Esta función se utiliza para localizar el elemento E en el arreglounidimensional A. Si se encuentra, la función regresa la posición correspondiente. En caso contrario regresa 0. */
{
int RES, I = 0, BAN = 0;
while ((I < T) && (E >= A[I]) && !BAN)
